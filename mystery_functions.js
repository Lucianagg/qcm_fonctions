...
function erogahtyp(a) { 
	let result;
	if(a%2 == 0) { //  Quand t'as un % ce qu'on va demandé à l'ordi c est le reste de la division des 2 nombres . exemple 
	               //  4%2 =2 donc le reste c 0  
		result = a/2;// donc on va utiliser ce résultat là 
	}                 
	else {
		result = 3*a+1;  // exemple on fait 3x5+ 1 +16 , ici on nepouvait pas utiliser le modulo car le reste était pas à =0 
	}
	return result;
}
